...
$meu_comentario_js = $minha_avaliacao ? $minha_avaliacao['comentario'] : '';
?>
...
<head>
  ...
  <style>
    ...
    .opiniao-estrelas .star { 
        font-size: 1.1rem; /* Estrelas das avaliações listadas */
        color: #ddd; 
        letter-spacing: 1px;
    }
    .opiniao-estrelas .star.filled { 
        color: #f5c518; /* Amarelo da estrela preenchida */
    }
    .opiniao-item p { 
        margin: 10px 0 5px; 
        color: #333;
    ...
    .btn-link-excluir { 
        background: none; 
        border: none; 
        color: #D9534F; /* Vermelho para excluir */
        cursor: pointer; 
        padding: 0; 
        font-size: 0.9rem; 
        font-weight: 500;
        ...
        <?php if ($usuario_logado): ?>
            <div class="opiniao-form-container" id="opiniao-form-container">
                ...
                <div class="opiniao-form">
                    <textarea id="opiniao-textarea" placeholder="Escreva sua opinião aqui..."><?php echo htmlspecialchars($meu_comentario_js); ?></textarea>
